    ...
    return (
        <div>
            ...
            <Box sx={{height:400, width:'100%'}}>
                <DataGrid columns={columns} rows={props.cases.map(sc => ({id:sc.caseNr, ...sc}))}></DataGrid>
            </Box>
        </div>
    );
}

function createColumnsFromArguments(cases: ScenarioCaseModel, t:TFunction<"translation", undefined, "translation">): GridColDef[]{
  return [
      {
          field: "index",
          headerName: "#",
      ...
      ...[...cases.explicitArguments, ...cases.derivedArguments]
          .map(argument => ({field: argument, headerName: argument})),
  ]
}
